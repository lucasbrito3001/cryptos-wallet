<template>
    <main>
        <header>
            ...
            <h3>Based on <a href="https://coinmarketcap.com/" target="_blank">CoinMarketCap</a> API</h3>
        </header>
        <Converter :initSelected1="1" :initSelected2="825" :cryptos="cryptos" class="converter-component"/>
    </main>
    <aside>
